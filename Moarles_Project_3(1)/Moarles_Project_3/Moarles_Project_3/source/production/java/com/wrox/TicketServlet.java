...
public class TicketServlet extends HttpServlet
{
    ...
    private void createTicket(HttpServletRequest request,
            ...
            throws ServletException, IOException
    {
    	//Creating the ticket using the parameters given in the form
        ...
        ticket.setReservationName(request.getParameter("reservationName"));
        ticket.setAddress(request.getParameter("address"));
